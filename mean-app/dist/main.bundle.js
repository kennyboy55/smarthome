...
var DetailComponent = (function () {
    ...
    DetailComponent.prototype.refreshData = function (id) {
        ...
        this.dataService
            ...
            _this.htv = res.HTV;
            _this.ht = res.HTN;
            _this.money = Math.round((((res.TOE1 - res.TTE1) * res.tarief1) + ((res.TOE2 - res.TTE2) * res.tarief2)) * 100) / 100;
